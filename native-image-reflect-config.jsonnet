...
[
  ...
  class('root.EvaluatedJObject$$anon$3', '0bitmap$3'),
  class('root.EvaluationContext$ObjectImp', '0bitmap$5'),
  class('root.JobDescription$', '0bitmap$1'),
  class('root.JobRunner$', '0bitmap$2'),

  class('root.CoursierDependency$', '0bitmap$2'),
  class('root.CoursierParams$', '0bitmap$1'),
  class('root.JobDescription$', '0bitmap$1'),
  class('root.LazyValue$$anon$1', '0bitmap$1'),
  class('root.LazyValue$$anon$2', '0bitmap$2'),

  class('root.LazyValue$$anon$6', '0bitmap$3'),
  class('root.LazyValue$$anon$7', '0bitmap$4'),

  class('root.Bsp4sBloopServerConnection$$anon$1', '0bitmap$1'),
  class('root.Config$', '0bitmap$1'),
  class('root.Logger$', '0bitmap$1'),
